...
import cv2
import numpy as np
from organization.employer_main import Employer
...
current_employer = Employer(1)
# Load a sample picture and learn how to recognize it.
semen_image = face_recognition.load_image_file("Semen.jpg")
semen_face_encoding = face_recognition.face_encodings(semen_image)[0]

# Load a second sample picture and learn how to recognize it.
roma_image = face_recognition.load_image_file("Roma.jpg")
